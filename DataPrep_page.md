## Data Mining in Business Final Project

**Project description:** Tasked with using historical repayment data of 300,000+ loans to construct a model that identifies the probability of default for new loan applicants.  As with any banking institution, loan application requires a credit pull and you have information on the credit history of the borrower as well as any additional information provided at the time of application. The goal in this part of the project is prepare this data for modeling.
...
#Splitting Address into regions 
